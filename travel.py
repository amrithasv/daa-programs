...
if __name__ == "__main__":
    while True:
        ...
        if try_again != "yes":
            break
# Enter th number of drill holes(nodes): 4
...
# Enter the distance between node 2 and node 4:10
# Enter the distance between node 3 and node 4:12
# Optimal order of drilling:  [1, 2, 4, 3, 1]
# Optimal cost of drilling:  47.0