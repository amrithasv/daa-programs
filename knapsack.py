...
# Enter the weights of the items: 5 10 20 30 40
# Enter the costs of the items: 30 20 100 90 160
# Enter the capacity of the knapsack: 60
# maximun profit:  260
# selected coffee beans (index):  [4, 2]
# selected coffee beans (weights):  [40, 20]
# selected coffee beans (costs):  [160, 100]